				...
				<div className="mb-5" id="terminal-settings-section">
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal FenneQ will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							Set how long FenneQ waits for shell integration to activate before executing commands. Increase this
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							When enabled, FenneQ will reuse existing terminal windows that aren't in the current working directory.
					...
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether FenneQ runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
