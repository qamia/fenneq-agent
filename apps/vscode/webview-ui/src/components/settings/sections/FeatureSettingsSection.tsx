...
const agentFeatures: FeatureToggle[] = [
	{
		id: "subagents",
		label: "Subagents",
		description: "Let FenneQ run focused subagents in parallel to explore the codebase for you.",
...
const editorFeatures: FeatureToggle[] = [
	{
		...
		label: "Feature Tips",
		description: "Show rotating tips during the thinking phase to help you discover FenneQ features.",
	...
	},
	{
		id: "worktrees",
		label: "Worktrees",
		description: "Enables git worktree management for running parallel FenneQ tasks.",
...
const experimentalFeatures: FeatureToggle[] = [
	...
	},
	{
		...
		description: "Sometimes FenneQ just isn't feeling it today. For entertainment purposes only.",
