...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have FenneQ verify its work before finishing a task.',
	},
	{
		text: "Add a .clinerules file to your project root to give FenneQ project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before FenneQ takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give FenneQ access to external tools and APIs.",
	},
	{
		text: "FenneQ creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from FenneQ's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with FenneQ.",
	},
	{
		text: "FenneQ can browse websites — ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while FenneQ is thinking.
 */
