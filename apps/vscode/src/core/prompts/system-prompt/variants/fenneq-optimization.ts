...
2. INSPECT DATA — Before formulating, examine every data file involved: row counts, columns, units, date ranges, gaps, and anomalies. State what you found. Never assume units or completeness.
