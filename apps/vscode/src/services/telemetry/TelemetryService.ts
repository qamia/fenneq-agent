...
export class TelemetryService {
	...
	public async updateTelemetryState(didUserOptIn: boolean): Promise<void> {
		...
		// Qortex ships with IDE telemetry off by design — when the host has it
		// disabled we respect that silently instead of nagging users to turn it on.
		await HostProvider.env.getTelemetrySettings({});
	}
