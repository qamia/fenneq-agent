		...
		vscode.languages.registerCodeActionsProvider(
			...
			new (class implements vscode.CodeActionProvider {
				...
				provideCodeActions(
					...
					const addAction = new vscode.CodeAction("Add to FenneQ", vscode.CodeActionKind.QuickFix)
					addAction.command = {
					...
					const explainAction = new vscode.CodeAction("Explain with FenneQ", vscode.CodeActionKind.RefactorExtract) // Using a refactor kind
					...
					const improveAction = new vscode.CodeAction("Improve with FenneQ", vscode.CodeActionKind.RefactorRewrite) // Using a refactor kind
					...
					if (context.diagnostics.length > 0) {
						const fixAction = new vscode.CodeAction("Fix with FenneQ", vscode.CodeActionKind.QuickFix)
