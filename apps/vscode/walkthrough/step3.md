# Zenith, Borealis & Solstice — Pick the Right Power
...
All tiers run on **your own key** — the Qortex key you entered at first launch (your Anthropic API key). You pay Anthropic directly for your own usage, with per-task cost shown in the chat. More tiers (ChatGPT, Gemini, local models) are coming soon.

> **Tip:** for agentic tasks (where FenneQ edits files and runs commands), keep **Adaptive Thinking off** so tool use stays reliable.
